...
INTEGER :: checkstat
INTEGER, SAVE :: subdim,ntr,nmp,asds,nvr,nvt,nvp,a1,a2,a3
INTEGER, SAVE :: invst,nmpv,nmps
INTEGER, DIMENSION (:), ALLOCATABLE, SAVE :: cnfe,fcoln,tcnfe,tfcoln
REAL(KIND=i10), SAVE :: gor,got,gop,dnr,dnt,dnp
REAL(KIND=i10), SAVE :: b1,b2,b3,c1,c2,c3
...
OPEN(UNIT=20,FILE=mtimes,STATUS='old')   !rtravel.out
...
DO i=1,ntr
   ...
   READ(20,*)dmod(istep)    !rtravel.out
   READ(30,*)dref
   READ(40)nrow,dumb
